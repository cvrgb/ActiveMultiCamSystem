...
namespace cli
{
    ...
    private:
        ...
        {
        public:
            explicit CmdBase(const std::string &name, const std::string &alternative, const std::string &description, bool required, bool dominant, bool variadic) : name(name),
        ...
        {
        public:
            explicit CmdFunction(const std::string &name, const std::string &alternative, const std::string &description, bool required, bool dominant) : CmdBase(name, alternative, description, required, dominant, ArgumentCountChecker<T>::Variadic)
            {
            }
        ...
        {
        public:
            explicit CmdArgument(const std::string &name, const std::string &alternative, const std::string &description, bool required, bool dominant) : CmdBase(name, alternative, description, required, dominant, ArgumentCountChecker<T>::Variadic)
            {
            }
    ...
    public:
        ...
        Parser(int argc, const char **argv, std::string generalProgramDescriptionForHelpText) : _appname(argv[0]),
        ...
        Parser(int argc, char **argv, std::string generalProgramDescriptionForHelpText) : _appname(argv[0]),
                                                                                          _general_help_text(std::move(generalProgramDescriptionForHelpText))
        {
            for (int i = 1; i < argc; ++i)
            {
